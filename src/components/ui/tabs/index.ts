...
export const tabVariants = cva('', {
    variants: {
        ...
        theme: {
            ...
            outline: 'text-[#5E6268] text-data-[state=active]:bg-transparent data-[state=active]:text-[#FD4F00] data-[state=active]:shadow-sm !text-base !font-medium text-black !font-roboto',
